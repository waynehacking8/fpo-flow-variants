...
\block{1. Motivation and Research Question}{
    ...
    \coloredbox[bgcolor=lightblue,framecolor=neuripsblue]{
        ...
        \begin{enumerate}[leftmargin=*]
            \item Which flow schedule works best for RL?
            \item When does FPO outperform PPO?
            \item Why does FPO fail on imitation tasks?
        \end{enumerate}
    }
}
...
\block{5. Main Results: OT Wins All Tasks}{
    ...
    \midrule
    HumanoidGetup & \textbf{100\%} & 97.7\% & 98.0\% \\
    Go1 Getup & \textbf{100\%} & 47.4\% & 54.8\% \\
    Go1 Joystick & \textbf{100\%} & 91.1\% & 80.0\% \\
    Go1 Handstand & \textbf{100\%} & 35.3\% & 41.0\% \\
    \bottomrule
    \end{tabular}
}
...
\block{7. Why VE Fails (100\% NaN)}{
    ...
    \begin{itemize}[leftmargin=*]
        ...
        \item Scale mismatch causes NaN
    \end{itemize}
...
\block{8. FPO vs PPO: Task Dependency}{
    ...
    \midrule
    HumanoidGetup & 4201.9 & 2910.0 & \textcolor{neuripsgreen}{\textbf{+44\%}} \\
    Go1 Getup & 18.29 & 12.50 & \textcolor{neuripsgreen}{\textbf{+46\%}} \\
    Go1 Handstand & 3.34 & 1.78 & \textcolor{neuripsgreen}{\textbf{+87\%}} \\
    Go1 Joystick & 4.39 & 16.94 & \textcolor{neuripsred}{\textbf{-74\%}} \\
    \bottomrule
    \end{tabular}
...
\block{9. FPO Excels at Multimodal Tasks}{
    \textbf{Go1 Handstand:} Flip \textcolor{blue}{\textbf{LEFT}} or \textcolor{red}{\textbf{RIGHT}} -- both valid!
    ...
    \begin{itemize}[leftmargin=*]
        \item \textbf{PPO}: Averages modes, outputs zero, \textcolor{neuripsred}{FAILS}
        \item \textbf{FPO}: Captures both peaks, samples valid action, \textcolor{neuripsgreen}{WINS}
    \end{itemize}
}
...
\block{10. Why FPO Fails on SkillMimic}{
    ...
    \begin{itemize}[leftmargin=*]
        ...
        \item FPO ratio does not reflect action likelihood
        \item Better MSE does not mean better imitation policy
    \end{itemize}

    \coloredbox[bgcolor=lightorange,framecolor=neuripsorange]{
        \centering
        \textbf{FPO is NOT suitable for imitation learning tasks}
    }
}
...
% Conclusions
%-----------------------------------------------------------
\block{11. Conclusions and Guidelines}{
    \begin{enumerate}[leftmargin=*]
        ...
        \begin{itemize}
            \item Multimodal: \textbf{FPO}
            \item Unimodal tracking: \textbf{PPO}
            \item Motion imitation: \textbf{PPO}
        \end{itemize}
    \end{enumerate}
