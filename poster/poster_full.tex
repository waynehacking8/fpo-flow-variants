...
\settitle{
    ...
    \vbox{
        \centering
        \vspace{1cm}
        {\Huge \color{white} \textbf{Comparative Analysis of Flow Schedules in} \par}
        \vspace{0.5cm}
        {\Huge \color{white} \textbf{Flow Policy Optimization for Robot Learning} \par}
        \vspace{1cm}
        {\LARGE \color{white} Wei-Cheng Chiu, Shang-Yen Lee, Yu-Tang Chang, Li-Chen Kao \par}
        \vspace{0.5cm}
        {\Large \color{white} National Taiwan University, Department of CSIE \par}
        \vspace{1cm}
    }
}
