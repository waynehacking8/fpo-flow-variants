...
\block{5. Main Results: OT Wins All Tasks}{
    \begin{center}
    \includegraphics[width=0.92\linewidth]{figures/final_performance_comparison.png}
    \end{center}
    ...
    \begin{center}
    \includegraphics[width=0.8\linewidth]{figures/performance_heatmap.png}
    \end{center}
    ...
    \midrule
    HumanoidGetup & \textbf{100\%} & 98\% & 98\% \\
    Go1 Getup & \textbf{100\%} & 47\% & 55\% \\
    Go1 Joystick & \textbf{100\%} & 91\% & 80\% \\
    Go1 Handstand & \textbf{100\%} & 35\% & 41\% \\
    \bottomrule
    \end{tabular}
}
...
\block{6. Training Dynamics}{
    \begin{center}
    \includegraphics[width=0.9\linewidth]{figures/training_curves_comparison.png}
    \end{center}

    OT: Faster learning + higher final reward
}
...
\block{7. Why VE Fails (100\% NaN)}{
    \begin{center}
    \includegraphics[width=0.85\linewidth]{figures/ve_failure_comprehensive.png}
    \end{center}

    $\frac{d\sigma}{dt}|_{t=1} \approx \textcolor{neuripsred}{\mathbf{719}}$ \quad Actions: $a \in [-1, 1]$

    \coloredbox[bgcolor=lightred,framecolor=neuripsred]{
        \centering VE \textbf{incompatible} with bounded action RL
    }
}
