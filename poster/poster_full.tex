...
% Motivation
%-----------------------------------------------------------
\block{\normalsize 1. Motivation and Research Question}{
...
% Method
%-----------------------------------------------------------
\block{\normalsize 2. Flow Schedules Compared}{
...
% Experimental Setup
%-----------------------------------------------------------
\block{\normalsize 3. Experimental Setup}{
...
% SNR Analysis
%-----------------------------------------------------------
\block{\normalsize 4. Theoretical Analysis: SNR}{
...
% Main Results
%-----------------------------------------------------------
\block{\normalsize 5. Main Results: OT Wins All Tasks}{
    \begin{center}
...
% VE Failure
%-----------------------------------------------------------
\block{\normalsize 7. Why VE Fails (100\% NaN)}{
    \begin{center}
...
% FPO vs PPO
%-----------------------------------------------------------
\block{\normalsize 8. FPO vs PPO: Task Dependency}{
    \begin{center}
...
% Multimodality
%-----------------------------------------------------------
\block{\normalsize 9. FPO Excels at Multimodal Tasks}{
...
%-----------------------------------------------------------
\block{\normalsize 10. Why FPO Fails on SkillMimic}{
