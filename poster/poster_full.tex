...
\block{\large 5. Main Results: OT Wins All Tasks}{
    ...
    \textbf{Key Finding:} Largest gap in multimodal Go1 Handstand task.
}
...
\block{\large 6. Training Dynamics}{
    ...
    \textbf{Observations:}
    \begin{itemize}[leftmargin=*]
        \item OT: Faster initial learning + higher final reward
        \item VP/Cosine: Slower convergence, lower asymptotic reward
        \item Multimodal tasks show largest OT advantage
    \end{itemize}
}
...
\block{\large 7. Why VE Fails (100\% NaN)}{
    ...
    \begin{itemize}[leftmargin=*]
        ...
        \item VE velocity target: $\|v\| \approx 700$ -- Scale mismatch!
    \end{itemize}

    \coloredbox[bgcolor=lightred,framecolor=neuripsred]{
        \centering VE is \textbf{fundamentally incompatible} with bounded action RL
    }
}
