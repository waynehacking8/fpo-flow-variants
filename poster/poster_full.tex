...
\settitle{
    ...
    \vbox{
        \centering
        \vspace{1cm}
        {\Huge \textbf{Comparative Analysis of Flow Schedules in} \par}
        \vspace{0.5cm}
        {\Huge \textbf{Flow Policy Optimization for Robot Learning} \par}
        \vspace{1cm}
        {\LARGE Wei-Cheng Chiu, Shang-Yen Lee, Yu-Tang Chang, Li-Chen Kao \par}
        \vspace{0.5cm}
        {\Large National Taiwan University, Department of CSIE \par}
        \vspace{1cm}
    }
}
...
\block{3. Experimental Setup}{
    ...
    \begin{itemize}[leftmargin=*]
        ...
        \item Framework: JAX / Brax / MJX / IsaacGym
    \end{itemize}
}
...
\block{4. Theoretical Analysis: SNR}{
    ...
    \begin{equation*}
    \text{SNR}(t) = \frac{\alpha_t}{\sigma_t} = \frac{\text{signal strength}}{\text{noise strength}}
    \end{equation*}
    ...
    \begin{itemize}[leftmargin=*]
        ...
        \item VE: SNR drops to \textbf{1/80} at $t=1$ -- signal overwhelmed by noise!
    \end{itemize}
}
